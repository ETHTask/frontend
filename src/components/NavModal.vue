<template>
  <transition name="modal">
    <div class="modal-mask catamaran white" @click="configObj.onClose()">
      <div class="modal-container pa4">
        ...
        <div class="pa3 f3 hover-pointer" @click="configObj.onProjectsClick()">Projects</div>
        <div class="pa3 f3 hover-pointer" @click="configObj.onTeamsClick()">My teams</div>
...
.modal-mask {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(89, 145, 220, 1);
    transition: opacity .3s ease;
}

.modal-container {
    background-color: rgba(89, 145, 220, 0.8);
    border-radius: 2px;
