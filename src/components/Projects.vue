        ...
        <li
          ...
          class="flex items-center lh-copy pa3 ph0-l bb b--black-10">
            ...
            <div class="pl3 flex-auto">
              <span class="f6 db black-70">{{ project.name }}</span>
            </div>
            <div>
              <button class="bg-main-color pa2 white br3 f5 hover-pointer" @click="selectProject(project)">
                Select
              </button>
            </div>
        </li>
